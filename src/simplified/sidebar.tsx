...
import { AUTHOR_THEN_EXIT_ROUTE, SAVED_CARDS_ROUTE } from "./basicView";
            ...
            <div id="sage-sidebar" className={`border-end border-2 ${minimized ? "minimized" : ""}`} >
                ...
                <div className={`content d-flex flex-column ${minimized ? "minimized" : ""}`}>
                    ...
                    <div className="left-nav-button-group">
                        ...
                        <Button variant="sage-white-secondary" active={location.pathname.startsWith(`/${SAVED_CARDS_ROUTE}`)} className="left-nav-button" onClick={() => navigate(`/${SAVED_CARDS_ROUTE}`)}>Saved Cards</Button>
                    </div>
                    <p className="hline"></p>
                    <div className="left-nav-button-group">
